...
lb_Question = QLabel('Почему в африке голодают йети?')
...
rbtn_1 = QRadioButton('Почтому что там закончились люди')
rbtn_2 = QRadioButton('Там нет снега')
rbtn_3 = QRadioButton('Обама')
rbtn_4 = QRadioButton('Потому что им не помог мистер бист')
...
def next_question():
    main_win.cur_question = window.cur_question + 1 
...
questions_list.append(
    Question(
    'Гос. язык Погртугалии','Португальский','Английский','Дворфский','Эльфийский'))
